...
- **Svincolo giocatori** — un acquisto può essere svincolato (dal partecipante nella propria rosa o dalla regia per qualsiasi squadra): il giocatore torna disponibile, lo slot si libera e i crediti di rimborso seguono la regola scelta alla creazione (prezzo pieno, metà arrotondata per eccesso con minimo 1, 1 credito, oppure 0 crediti). Lo svincolo è sempre possibile, la politica decide solo quanti crediti tornano in cassa. Gli acquisti svincolati restano nello storico con il badge *Svincolato*.
